...
#Cargando la librer�a compartida
...
if operacion == "Trans":
	...
	if size[0] != size[2] and size[1] != size[3]:
		print("Las matrices tienen distintos tama�os, no se pueden sumar")
		sys.exit()
	...
	if size[1] != size[2]:
		print("El n�mero de columnas de la primera matriz no es el mismo que el numero de filas de la segunda matriz, no se pueden multiplicar")
		sys.exit()
